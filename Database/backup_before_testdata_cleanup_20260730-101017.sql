...
CREATE TABLE `exercises` (
  ...
  UNIQUE KEY `uq_exercises_name_muscle` (`exercise_name`,`muscle_id`),
...
CREATE TABLE `muscle_groups` (
  ...
  UNIQUE KEY `uq_muscle_groups_name` (`muscle_name`)
...
CREATE TABLE `personal_records` (
  ...
  PRIMARY KEY (`pr_id`),
  UNIQUE KEY `uq_personal_records_user_exercise` (`user_id`,`exercise_id`),
  KEY `fk_personal_records_exercise` (`exercise_id`),
  CONSTRAINT `fk_personal_records_exercise` FOREIGN KEY (`exercise_id`) REFERENCES `exercises` (`exercise_id`),
  CONSTRAINT `fk_personal_records_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
LOCK TABLES `personal_records` WRITE;
/*!40000 ALTER TABLE `personal_records` DISABLE KEYS */;
/*!40000 ALTER TABLE `personal_records` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `weight_logs` (
  ...
  PRIMARY KEY (`log_id`),
  UNIQUE KEY `uq_weight_logs_user_day` (`user_id`,`logged_on`),
...
CREATE TABLE `workout_sets` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `set_order` smallint unsigned DEFAULT NULL,
  `comments` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`set_id`),
  KEY `exercise_id` (`exercise_id`),
  KEY `fk_workout_sets_workout` (`workout_id`),
...
INSERT INTO `workout_sets` VALUES (1,1,1,60.00,10,40,'2026-02-02 18:04:38',1,NULL),(2,1,1,65.00,8,35,'2026-02-02 18:04:38',2,NULL),(3,1,3,70.00,10,45,'2026-02-02 18:04:38',3,NULL),(4,1,5,60.00,12,40,'2026-02-02 18:04:38',4,NULL),(5,1,9,12.00,12,30,'2026-02-02 18:04:38',5,NULL),(6,1,11,25.00,10,30,'2026-02-02 18:04:38',6,NULL),(7,2,3,40.00,15,75,'2026-02-03 13:45:41',1,NULL),(8,3,1,50.00,12,60,'2026-02-04 06:48:39',1,NULL),(9,4,17,120.00,15,60,'2026-02-05 05:43:01',1,NULL),(10,5,9,10.00,15,60,'2026-02-16 14:23:40',1,NULL),(11,6,2,25.00,12,45,'2026-02-17 12:55:09',1,NULL),(12,6,3,50.00,12,60,'2026-02-17 12:55:09',2,NULL),(13,7,3,40.00,15,60,'2026-02-18 07:57:30',1,NULL),(14,8,1,15.00,15,60,'2026-02-18 17:02:44',1,NULL),(15,8,1,20.00,12,45,'2026-02-18 17:02:44',2,NULL),(16,7,1,15.00,15,60,'2026-02-18 07:57:30',2,NULL),(17,7,1,20.00,12,45,'2026-02-18 07:57:30',3,NULL),(18,9,5,50.00,15,60,'2026-02-19 06:12:31',1,NULL),(19,9,9,10.00,15,30,'2026-02-19 06:12:31',2,NULL),(21,11,13,60.00,15,60,'2026-07-23 12:30:14',1,NULL),(22,11,13,70.00,12,45,'2026-07-23 12:30:14',2,NULL),(30,20,13,40.00,15,NULL,'2026-07-29 06:24:04',1,'back feeling sore'),(31,20,13,60.00,12,NULL,'2026-07-29 06:25:14',2,NULL),(33,22,8,62.50,6,NULL,'2026-07-30 03:55:23',2,NULL),(34,22,8,65.00,5,NULL,'2026-07-30 03:55:23',3,'Felt heavy, dropped the last rep.'),(36,25,8,62.50,6,NULL,'2026-07-30 04:10:35',2,NULL),(37,25,8,65.00,5,NULL,'2026-07-30 04:10:35',3,'Felt heavy, dropped the last rep.'),(39,28,8,62.50,6,NULL,'2026-07-30 04:10:49',2,NULL),(40,28,8,65.00,5,NULL,'2026-07-30 04:10:49',3,'Felt heavy, dropped the last rep.'),(42,31,8,62.50,6,NULL,'2026-07-30 04:11:05',2,NULL),(43,31,8,65.00,5,NULL,'2026-07-30 04:11:05',3,'Felt heavy, dropped the last rep.');
...
CREATE TABLE `workouts` (
  ...
  UNIQUE KEY `uq_workouts_user_date` (`user_id`,`workout_date`),
...
INSERT INTO `workouts` VALUES (1,1,'2026-02-02','2026-02-02 18:04:38'),(2,1,'2026-02-03','2026-02-03 13:45:41'),(3,1,'2026-02-04','2026-02-04 06:48:39'),(4,1,'2026-02-05','2026-02-05 05:43:01'),(5,2,'2026-02-16','2026-02-16 14:23:40'),(6,2,'2026-02-17','2026-02-17 12:55:09'),(7,4,'2026-02-18','2026-02-18 07:57:30'),(8,2,'2026-02-18','2026-02-18 17:02:44'),(9,2,'2026-02-19','2026-02-19 06:12:31'),(11,10,'2026-07-23','2026-07-23 12:30:14'),(20,14,'2026-07-29','2026-07-29 06:24:04'),(22,19,'2026-07-30','2026-07-30 03:55:23'),(25,21,'2026-07-30','2026-07-30 04:10:35'),(28,23,'2026-07-30','2026-07-30 04:10:49'),(31,25,'2026-07-30','2026-07-30 04:11:05');
...
-- Dump completed on 2026-07-30 10:10:18
